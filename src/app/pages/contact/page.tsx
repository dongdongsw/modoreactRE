                    ...
                    <div className="heading3">가게등록</div>
                        <div className="store-name grid sm:grid-cols-2 grid-cols-1 gap-4 gap-y-5">
                            ...
                            <div className="address-container">
                             <p>
                                <strong>가게 주소:</strong>
                                    ...
                                    <div className="block-button md:mt-6 mt-4 flex items-center gap-4">
                                        <input
                                            type="text"
                                            name="address"
                                            ...
                                            readOnly
                                            placeholder="주소"
                                            className="store-input border-line px-4 py-3 w-full rounded-lg"
                                        />
                                        <button
                                            type="button"
                                            onClick={execDaumPostcode}
                                            className="small-button button-main px-4 py-3 bg-black text-white"
                                        >
                                            주소 검색
                                        </button>
                                    </div>
                            ...
                            <div className="image-upload-container">
                                <div className="form-button-group block-button md:mt-6 mt-4">
                                    <input
                                        type="file"
                                        accept="image/*"
                                ...
                                {storeInfo.imageUrl && (
                                    <img src={imageUrl} alt="가게" width="100" />
                                )}
                            </div>
