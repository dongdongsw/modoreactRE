...
import UserInfo, { UserInfoContent } from './UserInfo';
import PaymentHistory, { PaymentHistoryContent } from './PaymentHistory';
import CartItems, { CartContent } from './CartItems';
                ...
                <div className="container">
                    {isAuthenticated ? (
                                ...
                                <div className="user-infor bg-surface lg:px-7 px-4 lg:py-10 py-5 md:rounded-[20px] rounded-xl">
                                    <div className="heading flex flex-col items-center justify-center">
                                        <div className="avatar">
                                            <Image
                                                src={'/images/avatar/personMy.png'}
                                                width={300}
                                                height={300}
                                                alt='avatar'
                        ...
                        <div className="text-center mt-10">
                            <h2 className="text-lg font-semibold">로그인 후 진행해주세요.</h2>
                        </div>
                    )}
                </div>
            </div>
